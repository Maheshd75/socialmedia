  ...
  return (
    ...
    items-center justify-center' style={{backgroundColor: viewStory.media_type ===
        'text' ? viewStory.background_color:'#000000'}}>
            ...
            <div className='absolute top-0 left-0 w-full h-1 g-gray-700'>
            ...
            sm:size-8 backdrop-blur-2xl rounded bg-black/50'>
            ...
            <div className='max-w-[90vw] max-h-[90vh] flex items-center
            justify-center'>
                {renderContent()}
            </div>
